package com.wu.utils.okhttp.model;
...
public class HttpHeaders implements Serializable {
    ...
    public static long getTimeDate(String gmtTimes) {
        try {
            return parseGMTToMillis(gmtTimes);
     ...
     */
    public static long parseGMTToMillis(String gmtTimes) throws ParseException {
        if (TextUtils.isEmpty(gmtTimes)) return 0;
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat(FORMAT_HTTP_DATA, Locale.UK);
        simpleDateFormat.setTimeZone(GMT_TIME_ZONE);
        Date date = simpleDateFormat.parse(gmtTimes);
        return date.getTime();
    }
