...
public class PopWindow extends PopupWindow {
    private Button btnPhoto, btnGallery, btn_cancel;
    ...
    public PopWindow(Activity context, View.OnClickListener itemsOnClick) {
        ...
        btnPhoto = (Button) mMenuView.findViewById(R.id.btn_photo);
        btnGallery = (Button) mMenuView.findViewById(R.id.btn_gallery);
